...
function buttonAction(event) {
    ...
    let apiURL = 'https://api.shecodes.io/ai/v1/generate?prompt=Generate a poem about ${instructionsInput.value}&context=You are a wisdom-filled expert and love to give people information about poems. Your mission is to generate a short 6-line poem based on User instructions below, make it short and simple.Make sure to follow the user instructions.&key=37o01tf961eb43e8aa46dbf5fa9e5225';
